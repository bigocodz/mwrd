...
export default function SupplierOrdersPage() {
  ...
  return (
    <>
      <PageHeader
        title="Orders"
        description="Manage orders you need to fulfill."
      />
        ...
        {loading ? (
          ...
          <>
            <Table>
              ...
              <TableBody>
                {paged.map((o) => (
                  <TableRow key={o.id} onClick={() => router.push(`/supplier/orders/${o.id}`)}>
                    ...
                    <TableCell>
                      <button
                        type="button"
                        onClick={(e) => { e.stopPropagation(); router.push(`/supplier/orders/${o.id}`) }}
